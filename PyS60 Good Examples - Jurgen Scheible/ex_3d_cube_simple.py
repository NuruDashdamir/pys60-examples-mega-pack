...
# This script creates a cube that spins around 3 axis
# spin axis can be changed by pressing the arrow keys:
# down arrow key it should spin only around the x-axis
# right arrow key it should spin only around the y-axis
# left arrow key it should spin only around the z-axis
