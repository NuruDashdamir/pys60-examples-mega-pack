...
def run():
 ...
 img.text((3,11),txt,fill=0x303030,font=u'alp')
 img.text((5,206),u'fm',fill=0x303030,font=u'latinbold12')
 ...
 while i<15:
  try:
   ...
   if len(dfid)==2:
    ...
    if len(os.listdir(dfid))>0:img.text((5,i1224),'+  '+txt,fill=0x303030,font=u'apl')
    else:img.text((5,i1224),'  '+txt,fill=0x303030,font=u'alp')
