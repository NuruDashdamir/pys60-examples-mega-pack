...
while running:
    ...
    img.line((x,y,30,95,),0x999999,width=razmer)
    img.line((x,y,95,35,),0x9999ff,width=razmer)
    img.point((x+5,y+5,),0x229999,width=razmer+2+2)
    img.point((x+5+5+2,y+5+2+5,),0x999911,width=razmer+2+2+2+2)
    img.point((x+2+2+5+5+5,y+5+5+5+2+2,),0x991199,width=razmer+2+2+2+2+2+2)
    img.point((x+2+2+5+5+5+6,y+5+5+5+2+2+6,),0xff1199,width=razmer+2+2+2+2+2+2+6)
    img.ellipse((x,y,x+razmer-20,y+razmer-20),0x229999,width=x/2)
